module managers
{
    export class ScoreBoard
    {
        ...
        {
            this._livesLabel = new objects.Label("Lives: 99", "20px", "Arial Black", "#FFFF00", 20, 20);
            this._scoreLabel = new objects.Label("Score: 99999", "20px", "Consolas", "#FFFF00", 20, 50);
            this._highScoreLabel = new objects.Label("High Score: 99999", "40px", "Consolas", "#FFFF00", config.Game.SCREEN_WIDTH/2, 50);
